...
public abstract class BPTreeNode<T extends Comparable<T>> implements Serializable {
	...
	public abstract void insertRef(T key, Ref recordReference);

	public abstract void deleteRef(T key, Ref recordReference);
	...
	public abstract boolean deleteKeyAndRef(T key, Ref r, BPTreeInnerNode<T> parent, int ptr);

	public abstract boolean updateKeyAndRef(T key, Ref oldR, Ref newR, BPTreeInnerNode<T> parent, int ptr);
